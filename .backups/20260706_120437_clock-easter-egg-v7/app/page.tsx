...
export default async function Home() {
  ...
  let aboutData: { headline?: string; bio?: string; currentRole?: string; location?: string; contactEmail?: string; coverImageUrl?: string; currentCity?: string; timezone?: string } | null = null;
