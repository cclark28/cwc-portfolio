...
export default function HomeClient({ work, photo, playground = [], sitePassword, passwordEnabled, commandModule, aboutData }: HomeClientProps) {
  ...
  const heroLocationText = aboutData?.heroLocation ?? 'Worldwide';
  ...
  return (
    ...
    >
      ...
      <div style={{ opacity: pastHero ? 1 : 0, transition: 'opacity 0.4s ease' }}>
        <LocationClock
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <HelpRow cmd="playground" desc="Open the playground" />
