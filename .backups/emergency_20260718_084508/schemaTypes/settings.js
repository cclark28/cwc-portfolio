  ...
  fields: [
    ...
    // Command module / Terminal settings
    {
      ...
      fields: [
        ...
        // New field for View Work button
        { name: 'viewWorkLabel', title: 'View Work Button Label', type: 'string', description: 'Text for the button at the bottom of the hero (sentence case)', initialValue: 'View work' },
      ],
    },
  ],
}