...
import type { Category, SizedCanvasItem } from '@/lib/canvasLayout';
...
const Canvas = forwardRef<CanvasHandle, CanvasProps>(function Canvas(
  { work, photo, onOpenProject, cardGap = 48 },
  ref
) {
  const all = [...work, ...photo];
  ...
  const recompute = useCallback(
    (nextScale?: number, nextFilter?: Category | null) => {
      ...
      const newLayout = computeLayout(work, photo, vw, cardGap);
    ...
    [work, photo, cardGap, filter, scale] // eslint-disable-line react-hooks/exhaustive-deps
  );
          ...
          return (
            <div
              ...
              style={{
                ...
                transform: !revealed ? 'scale(0.85) translateY(10px)' : 'scale(1) translateY(0)',
